class ListFuncionario extends HFSSystemUtil {
	constructor()
	{
		super();
		...
		this._paginationNumber = $('#funcionario_paginationNumber');
		this._paginationSize = $('#funcionario_paginationSize');
		this._paginationSort = $('#funcionario_paginationSort');
		this._columnOrder = $('#funcionario_columnOrder');
		this._columnTitle = $('#funcionario_columnTitle');
		...
		this._form = $('#formListFuncionario');
		this._cmbReportType = $('#cmbReportType');
		this._forceDownload = $('#forceDownload');			
		this._dlgDeleteConfirmation = $('#dlgDeleteConfirmation');
		this._formTitle = $('#formTitle');
		this._formListFuncionario = $('#formListFuncionario');
			
		this._tableList = $('#tableFuncionario');
		this._selectedRow = '#tableFuncionario tbody tr.selected';
	...
	btnEditClick(event) {
		...
		if (selectedRow && selectedRow.id > 0) {		
			...
			this._formListFuncionario.submit();	
		} else {
...
const listFuncionario = new ListFuncionario();
