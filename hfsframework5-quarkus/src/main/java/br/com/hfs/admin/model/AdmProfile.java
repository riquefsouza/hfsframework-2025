...
public class AdmProfile implements Serializable {
	...
	@Column(name = "PRF_ADMINISTRATOR", length = 1)
	...
	/** The general. */
	//@Convert(converter = BooleanToStringConverter.class)
	@Column(name = "PRF_GENERAL", length = 1)
	...
	public AdmProfile(String description, Boolean administrator, Boolean general) {
		this();
		this.setAdministratorBooleano(administrator);
		this.description = description;
		this.setGeneralBooleano(general);
	}
	...
	public AdmProfile(ProfileVO p) {
		...
		this.id = p.getId();
		this.setAdministratorBooleano(p.getAdministrator());
		this.description = p.getDescription();
		this.setGeneralBooleano(p.getGeneral());
	...
	public Boolean getAdministratorBooleano() {
		return this.administrator.equals('S');
	}

	public void setAdministratorBooleano(Boolean administrator) {
		this.administrator = (administrator != null && administrator) ? 'S' : 'N';
	}
	...
	public Boolean getGeneralBooleano() {
		return this.general.equals('S');
	}

	public void setGeneralBooleano(Boolean general) {
		this.general = (general != null && general) ? 'S' : 'N';
	}
	...
	public ProfileVO toProfileVO(){
		...
		p.setId(id);
		p.setAdministrator(this.getAdministratorBooleano());
		p.setDescription(description);
		p.setGeneral(this.getGeneralBooleano());
