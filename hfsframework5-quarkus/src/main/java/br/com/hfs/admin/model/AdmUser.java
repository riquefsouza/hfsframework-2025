...
public class AdmUser implements Serializable {
	...
	@Column(name="USU_ACTIVE", length = 1)
	...
	public AdmUser(UserVO vo) {
		...
		//this.password = vo.ge;
		this.setActiveBooleano(vo.getActive());
	...
	public Boolean getActiveBooleano() {
		return active.equals('S');
	}

	public void setActiveBooleano(Boolean active) {
		this.active = (active != null && active) ? 'S' : 'N';
	}
