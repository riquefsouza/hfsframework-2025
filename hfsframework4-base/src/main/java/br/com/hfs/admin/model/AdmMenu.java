...
public class AdmMenu implements Serializable, Comparable<AdmMenu> {
	 ...
	 *
	 * @param description o novo the description
	 */
	 ...
	 *
	 * @param admPage o novo the adm pagina
	 */
	 ...
	 *
	 * @param admMenuParent o novo the adm menu
	 */
	 ...
	 *
	 * @param admSubMenus o novo the adm menus
	 */
	 ...
	 *
	 * @param admSubMenus the adm sub menus
	 * @return the adm menu
	 */
	 ...
	 *
	 * public List<AdmMenuFuncionario> getAdmMenuFuncionarios() { return
	 * this.admMenuFuncionarios; }
	 **
	 * 
	 * Atribui o the adm menu funcionarios.
	 *
	 * @param admMenuFuncionarios o novo the adm menu funcionarios
	 *
	 * public void setAdmMenuFuncionarios(List<AdmMenuFuncionario>
	 * admMenuFuncionarios) { this.admMenuFuncionarios = admMenuFuncionarios; }
	 **
	 * 
	 * Adiciona o adm menu funcionario.
	 *
	 * @param admMenuFuncionario the adm menu funcionario
	 * 
	 * @return the adm menu funcionario
	 *
	 * public AdmMenuFuncionario addAdmMenuFuncionario(AdmMenuFuncionario
	 * admMenuFuncionario) { getAdmMenuFuncionarios().add(admMenuFuncionario);
	 ...
	 * @return the adm menu funcionario
	 *
	 * public AdmMenuFuncionario removeAdmMenuFuncionario(AdmMenuFuncionario
	 * admMenuFuncionario) { getAdmMenuFuncionarios().remove(admMenuFuncionario);
	 ...
	 *
	 * @param idPage o novo the id pagina
	 */
