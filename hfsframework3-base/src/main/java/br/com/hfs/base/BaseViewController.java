...
public abstract class BaseViewController {
	...
	private static Logger log = LoggerFactory.getLogger(BaseViewController.class);
	...
	public static void addMessageErrorDialog(Exception e, String message) {
		PrimeFaces.current().dialog()
			.showMessageDynamic(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Erro", 
					ExceptionUtil.getErrors(LoggerFactory.getLogger(BaseViewController.class), e, message)));
	}
